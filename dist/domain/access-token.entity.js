...
__decorate([
    typeorm_1.Column('timestamp', { name: 'access_token_expires_at', nullable: false, default: () => 'now()' }),
    __metadata("design:type", Date)
], AccessTokenEntity.prototype, "accessTokenExpiresAt", void 0);
__decorate([
    typeorm_1.Column('timestamp', { name: 'refresh_token_expires_at', nullable: false, default: () => 'now()' }),
    __metadata("design:type", Date)
